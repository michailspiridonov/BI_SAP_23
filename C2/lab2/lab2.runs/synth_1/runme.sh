...
HD_PWD='X:/SAP/C2/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_bd_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_2_bd_vhdl.tcl
