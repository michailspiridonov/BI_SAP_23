...
HD_PWD='X:/SAP/C2/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_bd_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_2_bd_vhdl.tcl -notrace
