...
HD_PWD='X:/SAP/C6/project_final/project_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftTest_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ShiftTest_vhdl.tcl -notrace
