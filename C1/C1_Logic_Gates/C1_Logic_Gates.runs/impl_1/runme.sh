...
HD_PWD='X:/SAP/C1/C1_Logic_Gates/C1_Logic_Gates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gates_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gates_vhdl.tcl -notrace
