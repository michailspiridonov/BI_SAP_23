...
HD_PWD='X:/SAP/C1/C1_Logic_Gates/C1_Logic_Gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gates_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gates_vhdl.tcl
