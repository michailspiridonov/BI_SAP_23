...
HD_PWD='X:/SAP/C1/4bit_scitacka/4bit_scitacka.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder4_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder4_vhdl.tcl
