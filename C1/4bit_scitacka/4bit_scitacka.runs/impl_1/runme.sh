...
HD_PWD='X:/SAP/C1/4bit_scitacka/4bit_scitacka.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder4_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder4_vhdl.tcl -notrace
