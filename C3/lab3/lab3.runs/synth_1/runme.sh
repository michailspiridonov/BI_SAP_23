...
HD_PWD='X:/SAP/C3/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_7seg_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_7seg_vhdl.tcl
