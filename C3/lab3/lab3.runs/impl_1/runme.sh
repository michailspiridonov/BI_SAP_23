...
HD_PWD='X:/SAP/C3/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_7seg_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_7seg_vhdl.tcl -notrace
