...
#
# Generated by export_simulation on Fri Mar 10 15:47:50 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './adder4.sh' script.
...
./adder4.sh -noclean_files

For more information on the script, please type './adder4.sh -help'.
